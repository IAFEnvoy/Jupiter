...
public class VerticalScrollBar {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, int xPosition, int yPosition, int width, int height, int totalHeight) {
        ...
        if (totalHeight > 0) {
            ...
            context.fill(xPosition + 1, barPosition, width - 2, barHeight, this.foregroundColor);
