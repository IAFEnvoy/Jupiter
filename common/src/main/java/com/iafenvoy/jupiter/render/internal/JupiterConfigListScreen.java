...
public class JupiterConfigListScreen extends Screen {
    ...
    protected void init() {
        super.init();
        if (this.initialized)
            this.widget.setDimensionsAndPosition(this.width - 80, this.height - 70, 40, 64);
        else {
            this.initialized = true;
            this.widget = new JupiterConfigListWidget(this, this.client, this.width - 80, this.height - 70, 64, 24);
            this.widget.setX(40);
            this.widget.update();
        }
